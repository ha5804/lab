...
# Examples:
#   bash scripts/runpod_experiment.sh --dataset visa --model winclip --topk-heatmaps 8 --output-dir results_visa_winclip_split
#   bash scripts/runpod_experiment.sh --dataset visa --model adaptclip --adaptclip-checkpoint visa --device cuda --topk-heatmaps 8 --output-dir results_visa_adaptclip_split
#   bash scripts/runpod_experiment.sh --dataset mvtec --model patchcore --device cuda --k 10000 --topk-heatmaps 8 --output-dir results_mvtec_patchcore
